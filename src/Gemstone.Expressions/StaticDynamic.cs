...
namespace Gemstone.Expressions
{
    ...
    public class StaticDynamic : DynamicObject
    {
        ...
        public StaticDynamic(Type type)
        {
            m_type = type;
        }

        /// <summary>
        /// Provides the implementation for operations that get member values. Classes derived from the <see cref="DynamicObject"></see>
        ...
        /// statement, where <c>sampleObject</c> is an instance of the class derived from the <see cref="DynamicObject"></see> class,
        ...
        /// <summary>
        /// Provides the implementation for operations that invoke a member. Classes derived from the <see cref="DynamicObject"></see> class
        ...
        /// class derived from the <see cref="DynamicObject"></see> class, binder.Name returns "SampleMethod". The binder.IgnoreCase property
        ...
        /// <c>sampleObject.SampleMethod(100)</c>, where <c>sampleObject</c> is derived from the <see cref="DynamicObject"></see> class,
